...
public class Inventarios {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        do {
            ...
            System.out.printf("+-----------------------------------+\n");
            System.out.printf("1) Añadir artículo\n2) Eliminar Articulo\n3) Consultar artículo\n4) Consultar inventario\n5) Salir\n\n");
            ...
            try {
                ...
                if (menuOptionSelected > 0 && menuOptionSelected < 4) {
                    ...
                    if (menuOptionSelected == 2) {
                        ...
                        System.out.printf("\033[31mArtículo eliminado existosamente.\033[0m\n");
                    }
